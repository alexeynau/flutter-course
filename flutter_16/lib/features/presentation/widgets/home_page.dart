...
import 'package:flutter_16/features/data/repository/repository_impl.dart';
import 'package:flutter_16/features/domain/repository/repository.dart';
import 'package:flutter_16/features/presentation/widgets/person_list_tile.dart';
                      ...
                      : Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Text('addaptive app'),
                            ),
                            SizedBox(
                              width: MediaQuery.of(context).size.width < 900
                                  ? 500
